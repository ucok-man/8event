...
// TODO: When error from server occur please ensure user fix the error first before continue next step
        ...
        <Card className="mx-auto max-w-4xl shadow-lg">
          <CardHeader className="space-y-4 border-b bg-white px-8 py-6">
            ...
            <CardDescription className="text-base text-gray-600">
              Fill in the details below to create an unforgettable event that
