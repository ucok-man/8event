  ...
  theme: {
    extend: {
      ...
      animation: {
        ...
        smallpulse: 'smallpulse 2s cubic-bezier(0.4, 0, 0.6, 1) infinite',
        'alternate-grainy':
          'alternate-grainy 1s cubic-bezier(0.4, 0, 0.6, 1) infinite',
      },
    },
  },
